...
function ganhador(){
     ...
     if (numa > numb){
        txtmensagem.innerHTML = "Lakers ganhou!";
    }
    else if (numa < numb){
        txtmensagem.innerHTML = "Houston rockets ganhou!";
    }
    else {
...
function ganhando(){
     if (numa > numb)
        txtmensagem.innerHTML = "Lakers está ganhando!"; 
             else if (numa < numb)
                 txtmensagem.innerHTML = "Houston rockets está ganhando!";
        else 
